...
def api_commission():
    ...
    try:
        ...
        print(f"[Commission] HTTP {resp.status_code} | Item {item_id}")
        
        data = resp.json()
        print(f"[Commission] Resp: {json.dumps(data)[:800]}")
        ...
        # Lấy hoa hồng người bán (seller_commission), fallback về commission tổng
        ...
        # Parse số tiền an toàn (ép string trước khi regex)
